...
import org.travelers.service.ReplyService;
...
public class ReplyController {
	...
	*/
	@GetMapping(value="/page/{qno}/{page}",
            	produces= {MediaType.APPLICATION_ATOM_XML_VALUE,
          		             MediaType.APPLICATION_JSON_UTF8_VALUE})
	public ResponseEntity<ReplyPageDTO> getList(@PathVariable("page") int page,
		...
		ReplyPageDTO dto = service.getListWithPaging(cri, qno);
		log.info("ReplyDTO: "+dto);
		return new ResponseEntity<>(service.getListWithPaging(cri, qno),HttpStatus.OK);
