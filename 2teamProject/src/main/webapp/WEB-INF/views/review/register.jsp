		...
		<!-- left_cs_center -->
				<div class="left_cs_center">
					...
					<dt class="btn" style="text-align: center; margin: auto; font-size: 13px;
						...
						<li class="line"><a href="/review/list">문의사항</a></li>
					</dt>
				</div>
				<!-- /left_cs_center -->		
				<!-- /left_cs_center -->
...
<div class="content" style="margin-left: 5px;">
  <div class="row" style="width: 830px; height: 646px;">
	       <div class="col-lg-12" style="width: auto; height: auto;padding: 5px;">
				<form name="writeform" id="writeform" action="/review/register" method="post" enctype="multipart/form-data">
			        <table width="800px;" border="0" cellpadding="0" cellspacing="0" class="table_l" style="margin-left: 20px;">
		              ...
		              <tbody>
			             <tr>
				            <th>제목</th>
				               <td>
				                <input type="text" size="60" name="title" required="" style="height: 30px;">
								<!-- <span class="input_lo pl5"><input type="checkbox" name="secret" id="secret" value="Y">
								<label for="SECRET" title="비밀글 사용">비밀글 사용</label></span> -->
								</td>
			             </tr>

						<tr>
  				           <th>작성자</th>
				              <td><input type="text" name="writer"  title="작성자" value='<c:out value="${userName.name}"/>' style="height: 30px;"></td>
			           </tr>
					
			            <tr>
				           <td colspan="2" style="width: 730px; height: 350px;">
					        <textarea style="width: 800px; height: 350px;  resize:none;font-size: 14px; " name="content"></textarea>
						 </td>
			          </tr>
			          <tr>
			          <th>파일 첨부</th>
			          <td>
			          <div class="thumb">
					<input type="file" name="uploadFile" id="myFile" size="50">
   					<img src="https://placehold.it/160x90?text=IMAGE" id="myImg" style="width:20%" alt="Image"/>
					</div>
					</td>
					</tr>
		            <!--  <tr>
	...
	<br>
	<button type="submit" class="genric-btn success circle" style="float:right; font-size: small;">등록</button>
 </form>
	<!-- //글쓰기 폼 -->
<!-- //글쓰기 -->
