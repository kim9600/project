		...
		<div id="lNavi_wrap">
			...
			<div class="left_cs_center">
				...
				<dt class="btn" style="text-align: center; margin: auto; font-size: 13px; width: 156px; height: 34px;
					...
					<li class="line"><a href="/review/list">여행후기</a></li>
				</dt>
			</div>
			<!-- /left_cs_center -->		
			<!-- /left_cs_center -->
			...
			<div class="contents_wrap">
		  	<!--<div class="title_wrap">
				...
				<div class="board_search" style="float: right;">
					<form id='searchForm' action="/review/list" method='get' style="padding-bottom: 10px;">
						<select name='sfld' style="height: 30px; font-size: 13px;">
					...
					<ul>
						<c:forEach items="${list}" var="review">
							...
							<li>
								<!-- 이미지 -->
								<div class="thumb">
									<img src='<c:url value="/img/${review.images}"/>' style="width:100%">
								</div>
								<span class="title"><a class='move' href='<c:out value="${review.bno}"/>'><c:out value="${review.title}"/></a></span>
								<span class="name"><a href='<c:out value="${userName.name}"/>'></a></span>
								<!-- 작성일 -->
								<span class="date"><fmt:formatDate pattern="yyyy-MM-dd" value="${review.updateDate}" /></span>
							</li>
						</c:forEach>
					</ul>
				</div>
