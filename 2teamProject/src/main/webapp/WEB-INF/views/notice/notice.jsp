...
<!-- container -->
  ...
  <div class="board_search" style="float: right;">
	<form id='searchForm' action="/notice/notice" method='get' style="padding-bottom: 10px;">
			...
			<c:forEach items="${list}" var="notice">
						<tr>
							...
							<%--<td><a href='/board/get?bno=<c:out value="${board.bno}"/>'><c:out value="${board.title}"/></a></td>--%>
                             <%-- 자바스크립트로 get으로 이동 --%>
							<td style="font-color:red;"><a class='move' href='<c:out value="${notice.nno}"/>'>
...
<script type="text/javascript">
	...
	$(document)	.ready(	function() {
						...
						$(".move").on("click",function(e) {
											...
											actionForm
													.append("<input type='hidden' name='nno' value='"+ $(this).attr("href")+ "'>");
