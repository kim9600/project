...
<div id="container" style="height: 850px;">
  ...
  <div class="row" style="width: 830px; height: 646px;">
          <div class="col-lg-12" style="width: auto; height: auto; padding: 5px;">
                 <table width="800px;" border="0" cellpadding="0" cellspacing="0" class="table_l" style="margin-left: 20px;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th>제목</th>
                           <td><input class="form-control" size="60" name="title" value='<c:out value="${qna.title }"/>' readonly style="height: 30px;"></td>
                      </tr>
                  ...
                  <tr>
                     ...
                     <tr>
                       ...
                       <textarea style="width: 800px; height: 350px;  resize:none; font-size: 14px; text-align: left;" name="content" readonly><c:out value="${qna.content }" /></textarea>
                   </td>
                   </tr>
         ...
         <br>
          <c:if test="${userName.name==qna.writer && userName!=null}">
            <button data-oper='modify' class="btn btn-primary" style="float: right; width: 66px; margin-left: 5px ">수정</button>
            </c:if>
            <button data-oper='qna'   class="btn btn-default" style="float: right;">글목록</button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      $("button[data-oper='qna']").on("click", function(e) {
         ...
         operForm.attr("action", "/qna/qna").submit();
      });
   });
</script>
<!-- Modal -->
...
function showList(page){
  ...
  //댓글 조회 클릭 이벤트 처리 
    ...
    modalModBtn.on("click",function(e){
        //JSON객체 생성
      var reply={rno:modal.data("rno"), reply:modalInputReply.val(), qno:qnoValue};
