  ...
  <form role="form" action="/qna/modify" method="post">
			        ...
			        <table width="800px;" border="0" cellpadding="0" cellspacing="0" class="table_l" style="margin-left: 20px;">
		              ...
		              <tbody>
		                 <tr>
		                    <th>글 번호</th>
		                        <td>
		                           <input type="text"  name="qno" value= '<c:out value="${qna.qno }"/>' readonly style="height: 30px; width: 70px;"></td>
		                        </td>
		                 </tr>
			             <tr>
				            <th>제목</th>
				               <td><input class="form-control" size="60" name="title" value='<c:out value="${qna.title }"/>'  style="height: 30px;"></td>
			             </tr>

						<tr>
  				           <th>작성자</th>
				              <td><input type="text" name="writer" value='<c:out value="${qna.writer }"/>' style="height: 30px;" readonly></td>
			           </tr>

			            <tr>
				           <td colspan="2" style="width: 730px; height: 350px;">
					        <textarea style="width: 800px; height: 350px;  resize:none; font-size: 14px; text-align: left;" name="content" ><c:out value="${qna.content }" /></textarea>
						 </td>
			          </tr>
			          
			          <tr>
  				           <th>등록일자</th>
				              <td><input type="text" name="regdate" value='<fmt:formatDate value="${qna.regdate}" pattern="yyyy/MM/dd"/>' style="height: 30px;" readonly></td>
			           </tr>
			          
			          <tr>
  				           <th>수정일자</th>
				              <td><input type="text" name="updateDate" value='<fmt:formatDate value="${qna.updateDate}" pattern="yyyy/MM/dd"/>' style="height: 30px;" readonly></td>
			           </tr>
         ...
         <br>
           <!-- 수정,삭제,리스트가기 버튼  -->
            ...
            <button data-oper='submit'  data-oper='qna' class="btn btn-default" style="float: right;">글목록</button>
   </form>
</div>
