		  ...
		  <div class="mySlides">
				...
				<div class="row">
			    	...
			    	<p><%=pd[i].getDescription()%></p>
						...
						<p><form name="addForm" action="./addCart.jsp?id=<%=pd[i].getProductId()%>" method="post">
			...
			<div class="row" align="center">
			    ...
			    <%
			    	for(int i=0;i<pd.length;i++){
			    		...
			    		%>
			    <li class="page-item">
						<img class="demo cursor" src="./resources/images/<%=pd[i].getFilename()%>" style="width:100px" onclick="currentSlide(<%=i %>)" alt="<%=pd[i].getPname()%>">
					</li>
			    <%
			    		}
			    	}
			    %>
					...
					<c:if test="${pageNum>=total_page}">
			  	  <li class="page-item enabled"><a href="#">Next</a></li>
					</c:if>
		    </ul>
