		...
		<div> 
			<table class="table table-hover"> 
				...
				<tr> 
					...
					<td class="text-right"><%=new DecimalFormat("#,###").format(product.getUnitPrice())%></td> 
					<td class="text-right"><%=new DecimalFormat("#,###").format(total)%>원</td> 
				</tr> 
				<%}%> 
				<tr> 
					<td></td> 
					...
					<td class="text-right text-danger"> 
						<strong><%=new DecimalFormat("#,###").format(sum)%>원</strong></td>    
				</tr>
			</table> 
			<!-- 확정메뉴 --> 
