...
기존 비밀번호:<input type="password" id="oldPassword" name="oldPassword" autofocus required><br>
...
<input type="button" value="닫기" onclick="jabascript:self.close();">
</form>
...
<c:if test="${empty reslutSet.rows }">
	<script>
	alert('비밀번호를 확인해주세요');
	</script>
	</c:if>
